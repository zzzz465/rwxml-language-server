...
export function applyDecos(
  ...
  activeEditor.setDecorations(
    content_enum_decos,
    map.get(DecoType.content_Enum)!
  )
  activeEditor.setDecorations(
    content_integer_decos,
    map.get(DecoType.content_integer)!
  )
  activeEditor.setDecorations(
    content_float_decos,
    map.get(DecoType.content_float)!
  )
  activeEditor.setDecorations(
    content_defName_decos,
    map.get(DecoType.content_defName)!
  )
  activeEditor.setDecorations(
    content_image_decos,
    map.get(DecoType.content_image)!
  )
  activeEditor.setDecorations(
    content_bool_decos,
    map.get(DecoType.content_boolean)!
  )
  activeEditor.setDecorations(node_tag_decos, map.get(DecoType.node_tag)!)
  activeEditor.setDecorations(
    invalid_node_tag_decos,
    map.get(DecoType.invalid_node_tag)!
  )
